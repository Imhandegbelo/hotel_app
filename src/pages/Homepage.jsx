  ...
  return (
    <div>
      <header className="bg-black/50 flex flex-col gap-4 items-center justify-center h-[320px] md:h-[650px]">
        ...
        <div className="hidden md:block bg-gray-200/50 md:bg-gray-200 w-full max-w-[1080px] md:rounded-l-full md:rounded-r-full p-4">
          <form
            onSubmit={(e) => e.preventDefault()}
            className="flex flex-col md:flex-row justify-between items-center gap-4"
          >
            <div className="bg-white w-full md:max-w-[300px] rounded-l-full rounded-r-full px-6 py-1">
              <label
                htmlFor="guests"
              ...
              <input
                ...
                className="rounded-l-full bg-white rounded-r-full focus:outline-none"
              />
            </div>
            ...
            <div className="w-full md:bg-white md:border md:border-gray-400 flex flex-col gap-4 md:gap-0 md:flex-row justify-center rounded-l-full rounded-r-full md:divide-x divide-gray-400 md:px-3 py-1">
              <div className="bg-white w-full flex flex-col gap-1 px-6 py-1 rounded-l-full rounded-r-full md:rounded-none md:pr-2 md:pr-0 lg:px-5">
                <label
                  htmlFor="checkin"
                  className="text-sm sm:text-base my-0 py-0 flex items-center text-gray-500 md:gap-2"
                >
                  <MdOutlineDateRange />
                  Check-in-date
                </label>
                <input
                  ...
                  className="text-sm sm:text-base rounded-l-full bg-white md:bg-transparent focus:outline-none"
                />
              </div>
              <div className="bg-white w-full flex flex-col gap-1 px-6 py-1 rounded-l-full rounded-r-full md:rounded-none md:pr-2 md:pr-0 lg:px-5">
                <label
                ...
                <input
                  ...
                  className="text-sm sm:text-base rounded-r-full bg-white md:bg-transparent focus:outline-none"
                />
              </div>
            </div>
            <Button
              ...
              classList="px-6 py-3 uppercase w-full md:max-w-fit mx-auto md:mx-0"
            />
          </form>
        </div>
      </header>
